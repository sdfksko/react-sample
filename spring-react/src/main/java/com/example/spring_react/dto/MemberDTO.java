...
public class MemberDTO {
    ...
    public Member createMemberEntity(MemberDTO memberDTO) {
        return new Member(userId, userPassword, username, nickname, email, phoneNumber, postalAddress, address, detailedAddress, provider, role, createDate, block, profileImagePath);
    }
}
