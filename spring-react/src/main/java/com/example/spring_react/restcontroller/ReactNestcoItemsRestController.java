...
public class ReactNestcoItemsRestController {
    ...
    public ResponseEntity<Page<NestcoItems>> nestcoItemsPage(@PageableDefault(size = 6, sort = "createDate", direction = Sort.Direction.DESC) Pageable pageable) {
...
//        private Category category;    // 아이템과 카테고리 다대일
    ...
    public ResponseEntity<Page<NestcoItems>> filterSearch(@PageableDefault(size = 6, sort = "createDate", direction = Sort.Direction.DESC)Pageable pageable,
